...
public class Kmeans extends javax.swing.JFrame {
    ...
    int id;
     String name,last,email,gender,poll,val;
     
     
     String cql = "SELECT * FROM userpo";
     ...
     while(true)
     {
        for(Row r : initlist)
        {
            if (abs(cen1-r.getInt("val")) < abs(cen2-r.getInt("val")))
                {
                    if (abs(cen1-r.getInt("val")) < abs(cen3-r.getInt("val")))
                {
                    c1[count1] = r;
                    count1++;
            ...
            {
                if (abs(cen2-r.getInt("val")) < abs(cen3-r.getInt("val")))
                {
                    c2[count2] = r;
                    count2++;
                }   
